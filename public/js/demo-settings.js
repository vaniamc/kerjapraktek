jQuery(document).ready(function() {
	...
	jQuery(".demo-settings").append("<div class='demo-options'>"+
										...
										"<div class='option-box' rel='color-options'>"+
											"<div alt='header-colors'>"+
												"<b class='sub-title'>Header Color</b>"+
												"<a href='#' class='color-bulb active' style='background: #ffffff;'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: #1D1D1D;'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: #B4C2F0;'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: #748CDA;'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: #D07070;'>&nbsp;</a>"+
											"</div>"+
										"</div>"+
